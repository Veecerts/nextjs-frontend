...
// Define the column helper at the top
...
function CheckTable(props: { tableData?: RowObj[] }) {
  const { tableData = [] } = props; // Default to empty array if tableData is not provided

  const defaultData: RowObj[] = Array.isArray(tableData) ? tableData : [];
